...
// ============================================================================
// POST /api/pitches/[id]/pitchdeck/confirm-team
// ============================================================================
...
export async function POST(request: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  try {
    ...
    if (currentUser.role !== 'bl' && currentUser.role !== 'admin') {
      return NextResponse.json(
        { error: 'Forbidden: Only Business Line Leaders can confirm team' },
        { status: 403 }
      );
    }
    ...
    console.error('POST /api/pitches/[id]/pitchdeck/confirm-team error:', error);
    return NextResponse.json(
      {
