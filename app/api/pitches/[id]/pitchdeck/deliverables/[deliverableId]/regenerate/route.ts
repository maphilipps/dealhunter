...
import { pitches, pitchdeckDeliverables, pitchdecks, preQualifications } from '@/lib/db/schema';

// ============================================================================
// POST /api/pitches/[id]/pitchdeck/deliverables/[deliverableId]/regenerate
...
export async function POST(_request: NextRequest, { params }: RouteParams) {
  ...
  try {
    ...
    // 6. Get Qualification for context
    ...
    if (preQualification.extractedRequirements) {
      try {
        ...
        console.error('Error parsing Qualification extractedRequirements');
      }
    }
    ...
    console.error(
      'POST /api/pitches/[id]/pitchdeck/deliverables/[deliverableId]/regenerate error:',
      error
    );
    return NextResponse.json(
      {
