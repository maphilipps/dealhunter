...
import { backgroundJobs, dealEmbeddings, pitches } from '@/lib/db/schema';
import { QUALIFICATION_NAVIGATION_SECTIONS } from '@/lib/pitches/navigation-config';

/**
 * POST /api/pitches/[id]/visualize-all
 *
...
export async function POST(request: NextRequest, context: { params: Promise<{ id: string }> }) {
  try {
    ...
    console.log(`[VisualizeAll API] POST /pitches/${pitchId}/visualize-all`, {
...
/**
 * GET /api/pitches/[id]/visualize-all
 *
