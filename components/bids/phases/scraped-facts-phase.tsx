...
export function ScrapedFactsPhase({ quickScan, extractedData, bidId }: ScrapedFactsPhaseProps) {
  ...
  return (
    <div className="space-y-4">
      ...
      <Accordion type="multiple" defaultValue={['tech', 'content', 'company']} className="space-y-2">
        {/* 1. Tech Stack */}
          ...
          <AccordionTrigger className="px-4 hover:no-underline">
            <div className="flex items-center gap-2">
              ...
              {techStack?.cssFrameworks?.length ? (
                ...
                <Badge variant="secondary" className="ml-2">{techStack.cms}</Badge>
              ) : null}
            </div>
          </AccordionTrigger>
          <AccordionContent className="px-4 pb-4">
            <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    {techStack.cdnProviders?.map((cdn) => (
                      <Badge key={cdn} variant="outline">{cdn}</Badge>
                    ))}
                  </div>
                </div>
              ) : null}
              ...
              {techStack?.apiEndpoints?.rest?.length ? (
                <div>
                  <p className="text-xs text-muted-foreground mb-2">API Endpoints ({techStack.apiEndpoints.rest.length})</p>
                  <div className="text-xs font-mono bg-slate-100 p-2 rounded max-h-32 overflow-auto">
                    ...
                    {techStack.apiEndpoints.rest.length > 5 && (
                      <div className="text-muted-foreground">+{techStack.apiEndpoints.rest.length - 5} mehr</div>
                    )}
                  </div>
                </div>
              ) : null}
          ...
          <AccordionTrigger className="px-4 hover:no-underline">
            <div className="flex items-center gap-2">
              ...
              {contentVolume?.estimatedPageCount && (
                <Badge variant="secondary" className="ml-2">{contentVolume.estimatedPageCount} Seiten</Badge>
              )}
            </div>
          </AccordionTrigger>
          <AccordionContent className="px-4 pb-4">
                ...
                <div>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div className="text-center p-2 bg-slate-50 rounded">
                      ...
                      <p className="text-lg font-bold">{contentVolume.mediaAssets.documents || 0}</p>
          ...
          <AccordionTrigger className="px-4 hover:no-underline">
            <div className="flex items-center gap-2">
              ...
              {navigationStructure?.totalItems && (
                <Badge variant="secondary" className="ml-2">{navigationStructure.totalItems} Items</Badge>
              )}
            </div>
          </AccordionTrigger>
          <AccordionContent className="px-4 pb-4">
                ...
                <div className="grid grid-cols-3 gap-4">
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-1">
                      {navigationStructure.hasSearch && <Badge variant="outline" className="text-xs">Suche</Badge>}
                      {navigationStructure.hasBreadcrumbs && <Badge variant="outline" className="text-xs">Breadcrumbs</Badge>}
                      {navigationStructure.hasMegaMenu && <Badge variant="outline" className="text-xs">Mega Menu</Badge>}
                    </div>
                  </div>
                </div>
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-1">
                      {navigationStructure.mainNav.slice(0, 10).map((item, i) => (
                        <Badge key={i} variant="outline" className="text-xs">{item.label}</Badge>
                      ))}
                      {navigationStructure.mainNav.length > 10 && (
                        <Badge variant="secondary" className="text-xs">+{navigationStructure.mainNav.length - 10} mehr</Badge>
                      )}
                    </div>
                  </div>
                ) : null}
                ...
                {(integrations?.analytics?.length || techStack?.analytics?.length) ? (
                  <div>
                    ...
                    {(integrations?.analytics || techStack?.analytics)?.map((a) => (
                      <Badge key={a} variant="outline" className="mr-1 mb-1 text-xs">{a}</Badge>
                    ))}
                  </div>
                ) : null}
                {(integrations?.marketing?.length || techStack?.marketing?.length) ? (
                  <div>
                    ...
                    {(integrations?.marketing || techStack?.marketing)?.map((m) => (
                      <Badge key={m} variant="outline" className="mr-1 mb-1 text-xs">{m}</Badge>
                    ))}
                  </div>
                ) : null}
                {integrations?.payment?.length ? (
                  <div>
                    ...
                    {integrations.payment.map((p) => (
                      <Badge key={p} variant="outline" className="mr-1 mb-1 text-xs">{p}</Badge>
                    ))}
                  </div>
                ) : null}
        ...
        <AccordionItem value="accessibility" className="border rounded-lg">
          <AccordionTrigger className="px-4 hover:no-underline">
            <div className="flex items-center gap-2">
              ...
              {accessibilityAudit && (
                <Badge variant={accessibilityAudit.score >= 70 ? 'default' : 'destructive'} className="ml-2">
                  {accessibilityAudit.level && `WCAG ${accessibilityAudit.level} - `}{accessibilityAudit.score}%
                </Badge>
              )}
            </div>
          </AccordionTrigger>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-4 gap-2 text-center">
                  <div className="p-2 bg-red-50 rounded">
                    <p className="text-xl font-bold text-red-600">{accessibilityAudit.criticalIssues}</p>
                    <p className="text-xs text-red-600">Kritisch</p>
                  </div>
                  <div className="p-2 bg-orange-50 rounded">
                    <p className="text-xl font-bold text-orange-600">{accessibilityAudit.seriousIssues}</p>
                    <p className="text-xs text-orange-600">Schwer</p>
                  </div>
                  <div className="p-2 bg-yellow-50 rounded">
                    <p className="text-xl font-bold text-yellow-600">{accessibilityAudit.moderateIssues}</p>
                    <p className="text-xs text-yellow-600">Moderat</p>
                  </div>
                  <div className="p-2 bg-blue-50 rounded">
                    <p className="text-xl font-bold text-blue-600">{accessibilityAudit.minorIssues}</p>
                ...
                {accessibilityAudit.checks && (
                  <div className="flex flex-wrap gap-2">
                    ...
                    <StatusBadge ok={accessibilityAudit.checks.languageAttribute} label="Lang-Attribut" />
                    {accessibilityAudit.checks.colorContrast && (
                      <Badge variant={accessibilityAudit.checks.colorContrast === 'pass' ? 'default' : 'destructive'}>
        ...
        <AccordionItem value="legal" className="border rounded-lg">
          <AccordionTrigger className="px-4 hover:no-underline">
            <div className="flex items-center gap-2">
              ...
              {legalCompliance && (
                <Badge variant={legalCompliance.score >= 70 ? 'default' : 'destructive'} className="ml-2">
              ...
              <div className="space-y-4">
                ...
                {legalCompliance.checks && (
                  <div className="flex flex-wrap gap-2">
                    ...
                    <StatusBadge ok={legalCompliance.checks.hasCookieBanner} label="Cookie Banner" />
                    <StatusBadge ok={legalCompliance.checks.hasTermsOfService} label="AGB" />
                    <StatusBadge ok={legalCompliance.checks.hasAccessibilityStatement} label="Barrierefreiheit" />
                  </div>
                )}
                {legalCompliance.gdprIndicators?.cookieConsentTool && (
                  <div>
                    <p className="text-xs text-muted-foreground mb-1">Cookie Tool</p>
                    <Badge variant="outline">{legalCompliance.gdprIndicators.cookieConsentTool}</Badge>
                  </div>
                )}
              ...
              <div className="space-y-4">
                ...
                {performanceIndicators.resourceCount && (
                  <div className="grid grid-cols-4 gap-4">
                    <div className="text-center p-2 bg-slate-50 rounded">
                      <p className="text-xl font-bold">{performanceIndicators.resourceCount.scripts || 0}</p>
                      <p className="text-xs text-muted-foreground">Scripts</p>
                    </div>
                    <div className="text-center p-2 bg-slate-50 rounded">
                      <p className="text-xl font-bold">{performanceIndicators.resourceCount.stylesheets || 0}</p>
                      <p className="text-xs text-muted-foreground">Stylesheets</p>
                    </div>
                    <div className="text-center p-2 bg-slate-50 rounded">
                      <p className="text-xl font-bold">{performanceIndicators.resourceCount.images || 0}</p>
                      <p className="text-xs text-muted-foreground">Bilder</p>
                    </div>
                    <div className="text-center p-2 bg-slate-50 rounded">
                      <p className="text-xl font-bold">{performanceIndicators.resourceCount.fonts || 0}</p>
                ...
                {performanceIndicators.renderBlockingResources !== undefined && (
                  <div>
                    ...
                    <Badge variant={performanceIndicators.renderBlockingResources > 50 ? 'destructive' : 'secondary'}>
                ...
                <div className="p-3 bg-slate-50 rounded">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="font-medium">{companyIntelligence.dataQuality.confidence}% Confidence</p>
                    </div>
              ...
              <div className="space-y-4">
                ...
                {siteTree.sources && (
                  <div className="grid grid-cols-3 gap-4 p-3 bg-blue-50 rounded">
                    ...
                    <div className="text-center">
                      <p className="text-lg font-bold text-blue-800">{siteTree.sources.linkDiscovery}</p>
                      <p className="text-xs text-blue-600">Link Discovery</p>
                    </div>
                    <div className="text-center">
                      <p className="text-lg font-bold text-blue-800">{siteTree.sources.navigation}</p>
                ...
                {contentTypes.complexity && (
                  <Badge variant="outline" className="text-xs">
                    {contentTypes.complexity === 'simple' ? 'Einfach' :
                     contentTypes.complexity === 'moderate' ? 'Mittel' :
                     contentTypes.complexity === 'complex' ? 'Komplex' : 'Sehr komplex'}
                  </Badge>
                )}
              </div>
            </AccordionTrigger>
            <AccordionContent className="px-4 pb-4">
              <div className="space-y-4">
                ...
                {contentTypes.customFieldsNeeded && (
                  <div className="p-3 bg-slate-50 rounded">
                    <p className="text-xs text-muted-foreground">Geschätzte Custom Fields für CMS</p>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                    {decisionMakers.genericContacts.mainEmail && (
                      <div className="p-2 bg-slate-50 rounded">
                        ...
                        <button
                          onClick={() => copyToClipboard(decisionMakers.genericContacts!.mainEmail!)}
                    ...
                    {decisionMakers.genericContacts.salesEmail && (
                      <div className="p-2 bg-slate-50 rounded">
                        ...
                        <button
                          onClick={() => copyToClipboard(decisionMakers.genericContacts!.salesEmail!)}
                          className="text-sm font-medium flex items-center gap-1 hover:text-blue-600"
                        >
                          <Mail className="h-3 w-3" />
                          {decisionMakers.genericContacts.salesEmail}
                  ...
                  <div className="p-3 bg-purple-50 rounded">
                    <div className="flex justify-between items-center">
                      ...
                      <div className="text-right text-xs text-purple-600">
                        ...
                        <div>E-Mails bestätigt: {decisionMakers.researchQuality.emailsConfirmed || 0}</div>
                        <div>E-Mails abgeleitet: {decisionMakers.researchQuality.emailsDerived || 0}</div>
                      </div>
                    </div>
                  </div>
                )}
        ...
        {migrationComplexity && (
          <AccordionItem value="migration-complexity" className="border rounded-lg border-orange-200">
            <AccordionTrigger className="px-4 hover:no-underline">
              <div className="flex items-center gap-2">
                ...
                <Badge
                  variant="secondary"
                  className={`ml-2 ${
                    migrationComplexity.score < 30 ? 'bg-green-100 text-green-800' :
                    migrationComplexity.score < 50 ? 'bg-yellow-100 text-yellow-800' :
                    migrationComplexity.score < 70 ? 'bg-orange-100 text-orange-800' :
                ...
                <div className="flex items-center gap-4">
                  <div className="flex-1">
                    <Progress
                      ...
                      className={`h-4 ${
                        migrationComplexity.score < 30 ? '[&>div]:bg-green-500' :
                        migrationComplexity.score < 50 ? '[&>div]:bg-yellow-500' :
                        migrationComplexity.score < 70 ? '[&>div]:bg-orange-500' :
                        '[&>div]:bg-red-500'
                      }`}
                    />
                  </div>
                  <span className={`text-3xl font-bold ${getMigrationScoreColor(migrationComplexity.score)}`}>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                    {migrationComplexity.factors.cmsExportability && (
                      <div className="p-3 bg-slate-50 rounded">
                        ...
                        <p className="text-xl font-bold">{migrationComplexity.factors.cmsExportability.score}</p>
                    ...
                    {migrationComplexity.factors.dataQuality && (
                      <div className="p-3 bg-slate-50 rounded">
                        ...
                        <p className="text-xl font-bold">{migrationComplexity.factors.dataQuality.score}</p>
                      </div>
                    )}
                    {migrationComplexity.factors.contentComplexity && (
                      <div className="p-3 bg-slate-50 rounded">
                        <p className="text-xs text-muted-foreground mb-1">Content</p>
                        <p className="text-xl font-bold">{migrationComplexity.factors.contentComplexity.score}</p>
                        {migrationComplexity.factors.contentComplexity.customFields && (
                          <p className="text-xs text-muted-foreground">
                            {migrationComplexity.factors.contentComplexity.customFields} Custom Fields
                          </p>
                        )}
                      </div>
                    )}
                    {migrationComplexity.factors.integrationComplexity && (
                      <div className="p-3 bg-slate-50 rounded">
                        ...
                        <p className="text-xl font-bold">{migrationComplexity.factors.integrationComplexity.score}</p>
                        <p className="text-xs text-muted-foreground">
            ...
            <Card className="border-blue-200 bg-blue-50">
              <CardHeader>
                ...
                <CardDescription className="text-blue-700">
                  Matche die erkannten Anforderungen gegen verfügbare CMS-Systeme, um die beste Technologie-Empfehlung zu erhalten.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <Button
              ...
              <CardContent>
                ...
                {quickScan.recommendedBusinessUnit && (
                  <p className="text-xs text-orange-600 mt-3">
                    ...
                    AI-Empfehlung: <strong>{quickScan.recommendedBusinessUnit}</strong> mit {quickScan.confidence}% Confidence
                  </p>
                )}
              </CardContent>
            </Card>
