...
interface PreQualificationMobileNavProps {
...
export function PreQualificationMobileNav({
  preQualificationId,
  title,
  status,
  dataAvailability,
}: PreQualificationMobileNavProps) {
    ...
    <Sheet open={open} onOpenChange={setOpen}>
      <SheetTrigger asChild>
        <Button
          ...
          aria-label="Pre-Qualification Navigation"
        >
      ...
      <SheetContent side="right" className="w-[300px] sm:w-[400px]">
        <SheetHeader>
          <SheetTitle>Pre-Qualification Navigation</SheetTitle>
          <SheetDescription>
