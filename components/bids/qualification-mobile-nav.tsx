...
import {
  ...
  type QualificationScanDataAvailability,
} from '@/lib/qualifications/navigation';

interface QualificationMobileNavProps {
...
/** @deprecated Use QualificationMobileNav instead */
export type PreQualificationMobileNavProps = QualificationMobileNavProps;
/** @deprecated Use QualificationMobileNav instead */
export const PreQualificationMobileNav = QualificationMobileNav;

export function QualificationMobileNav({
  preQualificationId,
  title,
  status,
  dataAvailability,
}: QualificationMobileNavProps) {
  ...
  return (
    <Sheet open={open} onOpenChange={setOpen}>
      ...
      <SheetContent side="right" className="w-[300px] sm:w-[400px]">
        <SheetHeader>
          <SheetTitle>Qualification Navigation</SheetTitle>
          <SheetDescription>
            ...
            <div key={section.label}>
              ...
              <div className="flex flex-col gap-1">
                {section.items.map(item => {
                  ...
                  const isOverview = item.url === `/qualifications/${preQualificationId}`;
                  const isEnabled =
