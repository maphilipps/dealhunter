...
import { deletePreQualificationHard } from '@/lib/qualifications/actions';
...
export function DeleteQualificationButton({ preQualificationId, label, size = 'default' }: Props) {
