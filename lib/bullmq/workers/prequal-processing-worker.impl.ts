...
import { publishExtractedRequirementsFindings } from './prequal-processing/publish-helpers';
...
export async function processPreQualJob(
  ...
  try {
    ...
    publishExtractedRequirementsFindings(preQualificationId, extractedRequirements);
