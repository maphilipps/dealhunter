...
/**
 * Qualification Scan Component Catalog for json-render
 * Defines components AI can use to visualize Qualification Scan results
 *
...
// Component schemas
export const qualificationScanCatalogSchema = {
  // ========================================
  // Layout Components
  // ========================================
  ...
  ExecutiveSummary: z.object({
    blRecommendation: z.string(),
    blConfidence: z.number(),
  ...
  // ========================================
  // CMS Matrix Components
  // ========================================

  CMSMatrixSummary: z.object({
    cmsResults: z.array(
      z.object({
        name: z.string(),
        score: z.number(),
...
export const qualificationScanComponentDescriptions = {
  // Layout
  ResultCard:
  ...
  // Executive Summary
  ExecutiveSummary:
    'Executive summary card with BL recommendation, budget range, T-Shirt size, Go/No-Go score, and top risks',
  // Confidence
  ConfidenceBadge: 'Color-coded confidence badge (green ≥80, yellow ≥50, red <50)',
  // CMS Matrix
  CMSMatrixSummary: 'Compact top-3 CMS comparison with scores and recommendation badge',
  // Questions
  QuestionChecklist:
...
export const QUALIFICATION_SCAN_VISUALIZATION_SYSTEM_PROMPT = `You are a visualization expert that creates UI layouts for Qualification Scan results.
You output JSONL patches to build a UI tree from predefined components.

AVAILABLE COMPONENTS:
${Object.keys(qualificationScanComponentDescriptions).join(', ')}
...
**EXECUTIVE SUMMARY:**
- ExecutiveSummary: { blRecommendation, blConfidence, budgetRange: {min, max, confidence}, tShirtSize: "XS"|"S"|"M"|"L"|"XL"|"XXL", goNoGoScore, topRisks: [{title, severity, description}], opportunities?, oneLiner }

**CONFIDENCE:**
- ConfidenceBadge: { label, confidence: number, size?: "sm"|"md"|"lg" } - Color-coded badge (green ≥80, yellow ≥50, red <50)

**CMS MATRIX:**
- CMSMatrixSummary: { cmsResults: [{name, score: number, isRecommended: boolean}] } - Top-3 CMS comparison
...
export type QualificationScanCatalogComponents = keyof typeof qualificationScanCatalogSchema;

/** @deprecated Use qualificationScanCatalogSchema instead */
export const leadScanCatalogSchema = qualificationScanCatalogSchema;
/** @deprecated Use qualificationScanCatalogSchema instead */
export const quickScanCatalogSchema = qualificationScanCatalogSchema;
/** @deprecated Use qualificationScanComponentDescriptions instead */
export const leadScanComponentDescriptions = qualificationScanComponentDescriptions;
/** @deprecated Use qualificationScanComponentDescriptions instead */
export const quickScanComponentDescriptions = qualificationScanComponentDescriptions;
/** @deprecated Use QUALIFICATION_SCAN_VISUALIZATION_SYSTEM_PROMPT instead */
export const LEAD_SCAN_VISUALIZATION_SYSTEM_PROMPT = QUALIFICATION_SCAN_VISUALIZATION_SYSTEM_PROMPT;
/** @deprecated Use QUALIFICATION_SCAN_VISUALIZATION_SYSTEM_PROMPT instead */
export const QUICK_SCAN_VISUALIZATION_SYSTEM_PROMPT =
  QUALIFICATION_SCAN_VISUALIZATION_SYSTEM_PROMPT;
/** @deprecated Use QualificationScanCatalogComponents instead */
export type LeadScanCatalogComponents = QualificationScanCatalogComponents;
