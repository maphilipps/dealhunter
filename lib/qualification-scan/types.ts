/**
 * QualificationScan Types - Consolidated type definitions
 * Used across facts-tab, decision-matrix-tab, and qualification-scan-results components
 */
...
export interface QualificationScanResultsData {
...
/** @deprecated Use QualificationScanResultsData */
export type LeadScanResultsData = QualificationScanResultsData;
